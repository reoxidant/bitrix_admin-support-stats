...
$arFilter = array(
    ...
    "RESPONSIBLE_ID" => $find_responsible_id_stats,
    "RESPONSIBLE" => $find_responsible_stats,
    "RESPONSIBLE_EXACT_MATCH" => $find_responsible_exact_match_stats,
    "SLA" => $find_sla_id_stats,
    "CATEGORY" => $find_category_id_stats,
    "CRITICALITY" => $find_criticality_id_stats,
...
if ($find_mess == "Y" || $find_overdue_mess == "Y") {
    $arFilter = array(
        ...
        "DATE_CREATE_1" => $find_date1_stats,
        "DATE_CREATE_2" => $find_date2_stats,
        "OWNER_ID" => $find_responsible_id_stats,
        "OWNER" => $find_responsible_stats,
        "OWNER_EXACT_MATCH" => $find_responsible_exact_match_stats,
        "SLA" => $find_sla_id_stats,
        "CATEGORY" => $find_category_id_stats,
        "CRITICALITY" => $find_criticality_id_stats,
        "STATUS" => $find_status_id_stats,
