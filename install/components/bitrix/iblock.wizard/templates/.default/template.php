    ...
    <form method="post" action="<?= POST_FORM_ACTION_URI ?>" name="wizard">
        ...
        <table cellspacing=0 cellpadding=0 border=0 width=100%>
            <tr>
                ...
                <td background="<?= $templateFolder ?>/images/top_fill.gif" style="background-repeat: repeat-x"
                    align=center valign=middle width=60><img src="<?= $templateFolder ?>/images/icon2.gif"><br><img
                            src="/bitrix/images/1.gif" height=1 width=60></td>
                <td background="<?= $templateFolder ?>/images/top_fill.gif" style="background-repeat: repeat-x"
            ...
            <tr>
                <td height=6 width=6 align=left valign=bottom><img src="<?= $templateFolder ?>/images/bottom_left.gif">
                </td>
                <td background="<?= $templateFolder ?>/images/bottom_fill.gif"></td>
                <td background="<?= $templateFolder ?>/images/bottom_fill.gif"></td>
                <td height=6 width=6 align=right valign=bottom><img
                            src="<?= $templateFolder ?>/images/bottom_right.gif"></td>
            </tr>
        </table>
        <?
