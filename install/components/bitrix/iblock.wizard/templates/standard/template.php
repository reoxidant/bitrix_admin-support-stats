...
<div class="wizard">
    ...
    <form method="post" action="<?= POST_FORM_ACTION_URI ?>" name="wizard">
        ...
        <table class="data-table" cellspacing=0 cellpadding=0 border=0 width=100%>
            <tr>
                <th background="<?= $templateFolder ?>/images/top_fill.gif"
                    style="border:none;background-repeat: repeat-x" align=center valign=middle width=60><img
                            src="<?= $templateFolder ?>/images/icon.gif"><br><img src="/bitrix/images/1.gif" height=1
                                                                                  width=60></th>
                <th background="<?= $templateFolder ?>/images/top_fill.gif"
                    style="border:none;background-repeat: repeat-x" align=left valign=middle>
            ...
            ?>
            <tr>
                <td style="border-left:none;border-bottom:none;border-right:none"><img src="/bitrix/images/1.gif"
                                                                                       height=40 width=4></td>
                <td style="border-left:none;border-bottom:none;border-right:none" valign=bottom>
                    <div class=wizard_step><?= $arResult['CURRENT_STEP_TEXT'] ?></div>
                </td>
            </tr>
            <tr>
                <td style="border:none" colspan=2>
                    <hr size=1 style="background-color:#CCCCCC;height:1px;border: medium none;color:#CCCCCC;">
                </td>
            </tr>
            <tr>
                        ...
                        <? if (count($arResult['SECTIONS'])) { ?>
                            ...
                            <? } elseif ($arParams['BACK_URL']) { ?>
                                <input type=submit value="<?= GetMessage('BACK') ?>"
                                       onclick="javascript:window.location='<?= htmlspecialcharsbx(addslashes($arParams['BACK_URL'])) ?>';return false;">
                            <? } ?>
